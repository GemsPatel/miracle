...
*/	
	function checkAlias($str)
	{
		...
		if($c > 0)
		{
			$this->form_validation->set_message('checkAlias', getErrorMessageFromCode( '01029' ) );
			return false;
		}
		else
			return true;
...
*/
    function checkArticleKey($str)
    {
    	...
    	if($c > 0)
    	{
    		$this->form_validation->set_message('checkArticleKey', getErrorMessageFromCode( '01026' ) );
    		return false;
    	}
    	else
    		return true;
