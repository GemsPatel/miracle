	...
	public function index($alias = '')
	{
		...
		else if($this->form_validation->run() == TRUE)
		{
			...
			else
			{
				...
				$session = array( "admin_id" => $admin['admin_user_id'], "admin_user" => $admin['admin_user_emailid'], "admin_group_id" => $admin['admin_user_group_id'] );
	...
	function forgotPassword()
	{
		...
		else if($this->form_validation->run() == TRUE)
		{
			...
			if(!count($admin)):
				...
				$mail_body = "<p><b>Your Email:</b> ".$admin['admin_user_emailid']."</p>
							  <p><b>New Password:</b> ".$user_pass."</p>
