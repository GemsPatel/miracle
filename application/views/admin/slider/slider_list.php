						...
						<?php if($this->per_add == 0){?>
    						<button class="button button-gray">
    							<a href="<?php echo base_url( 'admin/'.$this->controller.'/'.$this->controller.'Form');?>" class="btn btn-secondary">
    								<i class="fa fa-file" aria-hidden="true"></i> New Slider
    							</a>
    						</button>
						<?php }?>
					</div>
    				...
    				<div class="col-md-12">
    					<div class="col-md-3">
    						<div class="form-group">
    							...
    							<input type="text" id="slider_name_filter" name="slider_name_filter" value="<?php echo @$_GET['slider_name_filter']?>" class="form-control" placeholder="Type to get Slider">        
    						</div>
    					</div>
    					<div class="col-md-2">
    						<div class="form-group">
    							<label>Status</label> 
    							<select name="slider_key_filter" class="form-control" id="status">
									<option value="">Select</option>
									<option value="1" <?php echo (@$_GET['slider_key_filter'] == "1")?'selected="selected"':'';?> >Enabled</option>
                                    <option value="0" <?php echo (@$_GET['slider_key_filter'] == "0")?'selected="selected"':'';?> >Disabled</option>
                                </select>
    						</div>
    					</div>
